...
class Uou_Addmorefields_Load_Template {


    protected $filter_prefix = 'uou-addmorefields';

    protected $theme_template_directory = 'uou-addmorefields';


    protected $plugin_directory = RB_CUSTOM_META_BOX_DIR;
